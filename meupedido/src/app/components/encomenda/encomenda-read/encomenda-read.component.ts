...
@Component({
  selector: 'app-encomenda-read',
  templateUrl: './encomenda-read.component.html',
  styleUrls: ['./encomenda-read.component.css']
})
export class EncomendaReadComponent implements OnInit {
  ELEMENT_DATA: Encomenda[] = []
  FILTERED_DATA: Encomenda[] = []
  
  displayedColumns: string[] = ['position', 'name', 'weight', 'obs', 'cidade', 'bairro', 'logradouro', 'num', 'symbol'];
